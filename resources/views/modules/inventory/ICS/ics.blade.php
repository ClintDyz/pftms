                ...
                <div class="card card-cascade narrower">
                    ...
                    <div class="px-2">
                        <div class="table-wrapper table-responsive border rounded">
                            ...
                            <!--Table-->
                            @if ($_ics->isEmpty())
                                <p class="text-center p-4">No ICS found.</p>
                            @else
                                <table class="table table-striped table-bordered table-hover" style="width:100%">
                                    ...
                                    <tbody>
                                        @foreach ($_ics as $item)
                                            <tr>
                                                <td>
                                                    <span class="item_class">{{ ($_ics->currentPage() - 1) * $_ics->perPage() + $loop->iteration }}</span>
                                                </td>
                                                <td>
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <p class="text-muted mb-0">
                                    Showing {{ $_ics->firstItem() }} to {{ $_ics->lastItem() }} of {{ $_ics->total() }} entries
                                </p>
                            </div>
                            <div>
                                {{ $_ics->links() }}
