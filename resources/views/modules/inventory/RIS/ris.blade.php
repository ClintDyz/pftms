                ...
                <div class="card card-cascade narrower">
                    ...
                    <div class="px-2">
                        <div class="table-wrapper table-responsive border rounded">
                            ...
                            <!--Table-->
                            @if ($_ris->isEmpty())
                                <p class="text-center p-4">No RIS found.</p>
                            @else
                                <table class="table table-striped table-bordered table-hover" style="width:100%">
                                    ...
                                    <tbody>
                                        @foreach ($_ris as $item)
                                            <tr>
                                                <td>
                                                    <span class="item_class">{{ ($_ris->currentPage() - 1) * $_ris->perPage() + $loop->iteration }}</span>
                                                </td>
                                                <td>
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <p class="text-muted mb-0">
                                    Showing {{ $_ris->firstItem() }} to {{ $_ris->lastItem() }} of {{ $_ris->total() }} entries
                                </p>
                            </div>
                            <div>
                                {{ $_ris->links() }}
