...
class PDF extends TCPDF {
    ...
    public function header() {
        ...
        if ($this->headerIcon && $this->headerVerRev) {
            ...
            $logoWidth = 115; // Adjust this value to make logo bigger/smaller
        ...
        if (!$this->generateInfoOnly) {
            ...
            if (!$this->onlyPageNo) {
                ...
                // $this->Cell(0, 4, '', 0, 0, 'L');
                          ...
                          // First line - centered
                $this->Cell(0, 4, 'All documented information printed from the Quality Management Information', 0, 1, 'C');

                // Second line - centered
                $this->Cell(0, 4, 'System (QMIS) are deemed "UNCONTROLLED".', 0, 1, 'C');
